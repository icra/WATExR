...
%
function [NSout metric_id MatchedData] = nashsutcliffe(obsDataX, simDataX)
    ...
    if r >= 2 
        ...
        SSE = nansum(E.^2);
        u = nanmean(MatchedData(:,2));
        SSU = nansum((MatchedData(:,2) - u).^2);

...
library(lubridate)
rea <- get(load("C:\\Users\\shikhani\\Documents\\LINUX/ERA5/ERA5_daily_Interpolated_March2020_pev.RData"))
obs <- get(load("C:\\Users\\shikhani\\Documents\\LINUX/ERA5/ERA5_daily_Interpolated_March2020_pev.RData"))
hind <- get(load("C:\\Users\\shikhani\\Documents\\LINUX/System_5/Data_final_2019/System5_final_5_6_7_8_uas_vas_tdps_tas_cc_tp_rsds_rlds_petH_BCcross.rda"))
obs$sp <- NULL
rea$sp <- NULL
...
output.dir.met <- "C:/Users/shikhani/Documents/LINUX/System_5/Data_for_models/2year_warmup/Pev"
